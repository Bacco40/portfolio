    ...
    <section className="sectionTransition" >
        ...
        <div className="aboutContent">
            ...
            <div className="description">
                <p>Hi! Matteo Bacchetti here, i'm a self taught <em>Full-Stack Developer! </em></p>
                ...
                front-end, <em>NodeJs, EXPRESS, MongoDB</em> and <em>Firebase</em> for the back-end, all of this to deliver great looking and performig website and App.</p>
        ...
        <div className="skills">
            ...
            <div className="skillsContainer">
                ...
                <div className="singleLogo">
                    ...
                    <p className="logoDescription">MONGODB</p>
                </div>
                <div className="singleLogo">
                    <img className="pugLogo" src={pugLogo} alt='pug logo'/>
                    <p className="logoDescription">PUGJS</p>
                </div>
                <div className="singleLogo">
                    <i className="devicon-heroku-plain colored"></i> 
                    <p className="logoDescription">HEROKU</p>
                </div>
            </div>
        </div>
        <hr/>
